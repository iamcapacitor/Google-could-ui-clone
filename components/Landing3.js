    ...
    <section className='p-20 min-h-screen bg-black text-white '>
        <div className="part1 border border-amber-200 flex ">
            ...
            <div className='w-1/2 text-xl'>
                <p>Lorem <a className='text-blue-600 hover:underline' href="/">ipsum, dolor</a> sit amet consectetur adipisicing elit. <a className='text-blue-600 hover:underline' href="/">Eligendi provident</a> libero qui quis, aspernatur dolore!</p>
